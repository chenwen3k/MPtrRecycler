...
public class PtrFrameLayout extends ViewGroup {
    ...
    private static int DEFAULT_AUTO_SCROLL_THRESHOLD = -1;
    ...
    private int mAutoScrollThreshold = DEFAULT_AUTO_SCROLL_THRESHOLD;
    ...
    public PtrFrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (arr != null) {
            ...
            mAutoScrollThreshold = arr.getInt(R.styleable.PtrFrameLayout_ptr_auto_scroll_threshold, DEFAULT_AUTO_SCROLL_THRESHOLD);
            arr.recycle();
        }
    ...
    public boolean dispatchTouchEvent(MotionEvent e) {
        ...
        switch (action) {
            case MotionEvent.ACTION_UP:
                ...
                if (DEBUG) {
                    PtrCLog.d(LOG_TAG, "startY = " + startY + ", e.getY() = " + e.getY());
                }
                if (mAutoScrollThreshold != DEFAULT_AUTO_SCROLL_THRESHOLD && mAutoScrollThreshold < mPtrIndicator.getCurrentPosY() && isSlideDown) {
                    if (DEBUG) {
                        PtrCLog.d(LOG_TAG, "mPtrIndicator.getCurrentPosY() = " + mPtrIndicator.getCurrentPosY() + ", isSlideDown = " + isSlideDown);
                    }
                    ...
                    mScrollChecker.tryToScrollTo(mPtrIndicator.getOffsetToRefresh(), mDurationToClose);
                    mStatus = PTR_STATUS_LOADING;
                    performRefresh();
                    mPtrIndicator.onRelease();
//                    mScrollChecker.tryToScrollTo(mPtrIndicator.getOfdispatchTouchEventfsetToRefresh(), mDurationToCloseHeader);
                    break;
                }
            ...
            case MotionEvent.ACTION_DOWN:
                startY = e.getY();
                if (DEBUG) {
                    PtrCLog.d(LOG_TAG, "e.getY() = " + e.getY());
                }
